    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="w-full">
            ...
            <div class="flex gap-2 mb-8">
                ...
                <p class="text-start text-gray-600 max-w-5xl">
                    Museum Maritim Indonesia saat ini memiliki total <span class="font-semibold">1400+</span> koleksi,
                    baik asli maupun replika. Beberapa koleksi museum didapatkan dengan cara hibah, baik dari
                    Kementerian terkait maupun pribadi yang bertemakan Kemaritiman dan Kepelabuhanan.
                </p>
            </div>
                ...
                @foreach ($collections as $collection)
                    <a href="{{ route('collection.show', $collection->slug) }}"
                        ...
                        <div
                            ...
                            <p
                                class="text-sm text-gray-200 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
