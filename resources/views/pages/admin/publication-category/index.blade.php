        ...
        <div class="modal fade" id="addcategory" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form method="POST" action="{{ route('admin.publication-categories.store') }}">
                        @csrf
                                ...
                                <div class="modal fade" id="updatecategory{{ $category->id }}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <form method="POST"
                                                action="{{ route('admin.publication-categories.update') }}">
                                                @csrf
                                                @method('put')
                                                <div class="modal-body px-4">
                                ...
                                <div class="modal fade" id="deletecategory{{ $category->id }}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <form method="POST"
                                                action="{{ route('admin.publication-categories.remove') }}">
                                                @csrf
                                                @method('delete')
                                                <div class="modal-body px-4">
